...
class GithubCollector(): 
    ...
    def get_dataset_column_names(self, github_data=GITHUB_DATA):
        return [data[PREFIX]+column for level, data in GITHUB_DATA.items() for column in data[ATTRIBUTES]]

    def _collect_data_from_repositories(self, repositories, github_data=GITHUB_DATA, repo_ids={}):
